...
export default function ResetPasswordPage() {
    ...
    const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            await resetPasswordValidation.parseAsync({
                password,
                confirmPassword,
            })
    ...
    return (
        <div className="grid min-h-screen place-items-center bg-background p-4 text-foreground">
            <div className="flex w-full flex-col overflow-hidden rounded-lg bg-reset-password-image bg-right shadow-xl sm:max-w-4xl md:flex-row">
