...
function LandingPage() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-yellow-50 to-white text-gray-800 overflow-hidden">
            <Header />
            ...
            <main>
                <section className="relative h-screen flex items-center justify-center overflow-hidden">
                    ...
                    />
                    <div className="relative z-10 text-center px-4 backdrop-blur-sm bg-white/50 w-full py-32">
                        <h2 className="text-5xl font-bold mb-6 text-yellow-800">
                        ...
                        <Button
                            size="lg"
                            className="mr-4 bg-yellow-500 hover:bg-yellow-700 text-white"
                        >
                            Get Started
                        </Button>
                        <Button
                ...
                <section id="features" className="relative py-24">
                    ...
                    <div className="container mx-auto px-4 relative z-10">
                        <h3 className="text-3xl font-bold text-center mb-12 text-yellow-800">
                            Features
                        </h3>
...
function FeatureCard({ icon: Icon, title, description }: FeatureCardProps) {
    return (
        <div className="bg-white/30 backdrop-blur-md p-6 rounded-lg shadow-md text-center hover:shadow-lg transition-shadow border border-yellow-100">
            <div className="flex justify-center mb-4">
                <Icon className="h-12 w-12 text-yellow-bg-yellow-500" />
            </div>
            <h4 className="text-xl font-semibold mb-2 text-yellow-800">
                {title}
            </h4>
